...
public class PageHelper extends JdbcDaoSupport {
	 ...
	 *            oracle语句
	 */
	public PageHelper(String sql) {
		if (jdbcTemplate == null) {
			throw new IllegalArgumentException("com.none.web.utils.jdbcTemplate is null,please initial it first. ");
		} else if (sql.equals("")) {
			throw new IllegalArgumentException("com.none.web.utils.PageHelper.sql is empty,please initial it first. ");
		}
		new PageHelper(sql, currentPage, NUMBERS_PER_PAGE, jdbcTemplate);
	}
	 ...
	 *            JdbcTemplate实例
	 */
	public PageHelper(String sql, int currentPage, int numPerPage, JdbcTemplate jTemplate) {
		if (jTemplate == null) {
			throw new IllegalArgumentException("com.none.web.utils jdbcTemplate is null,please initial it first. ");
